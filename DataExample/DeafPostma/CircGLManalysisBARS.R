...
# base_cgm <- circGLM(th = smallpd$imdev_signed, X = smallpd[, 3:4], Q = 10000, burnin = 1000,
#                     returnPostSample = TRUE, debug = FALSE, loopDebug = FALSE)
# print(base_cgm)
#
# plot(base_cgm)
...
# Runa model with covariates.
cov_cgm <- circGLM(th = covpd$imdev_signed, X = covpd[, c("age", "INT", "CON")], Q = 10000, burnin = 1000,
