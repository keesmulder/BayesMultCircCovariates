...
Due to the periodical nature of the outcome variable $\theta$, the conditional likelihood of any $\beta_j$ may have not be globally concave and may have more than one maximum. In this section, this issue will be explored.
...
First, consider a simple dataset, with a single predictor $\boldsymbol{X} = \left\lbrace -3, -2, \dots, 2, 3 \right\rbrace $ and $\theta_i = \frac{\pi}{2} + 2 \tan^{-1} (x_i), $ for each $ i \in 1, 2, \dots, 7.$ The relationship between the predictor and circular outcome is shown in figure \ref{SimpleDataset}.

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
## [1] "Mean direction: 5.44 radians"
## [1] "Mean direction: 5.44 radians"
## [1] "Mean direction: 5.44 radians"
\end{verbatim}
\end{kframe}
